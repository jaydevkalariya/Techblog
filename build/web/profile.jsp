                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 scroll">
                        ...
                        <div class="list-group mt-2">
                            <a href="#" onclick="getPosts(0, this)"  class=" c-link list-group-item list-group-item-action active bg">
                                All Posts
                            </a>
                            <a href="#" onclick="getPosts(-1, this)"  class=" c-link list-group-item list-group-item-action active bg">
                                Liked Posts
                            </a>
                             <a href="#" onclick="getPosts(-2, this)"  class=" c-link list-group-item list-group-item-action active bg">
                                Premium Posts
                            </a>
                            <br/>
                            <!--categories-->
                            ...
                            %>
                            <a href="#" onclick="getPosts(<%= cc.getCid()%>, this)" class=" c-link list-group-item list-group-item-action bg"><%= cc.getName()%></a>
                    ...
                    <div class="modal-body">
                        ...
                        <form id="add-post-form" action="AddPostServlet" method="post">
                            <input type="hidden" name="operation" value="addPost"/>
                              <input type="text" name="persontype" value="User" readonly="readonly"/>
